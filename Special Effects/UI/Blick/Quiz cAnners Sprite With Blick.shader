Shader "Quiz cAnners/UI/Sprite With Blick"{
	Properties
	{
	...
	//	_BumpMap("Bump Map", 2D) = "bump" {}
		...
		_Color("Blick Tint", Color) = (1,1,1,1)
		...
		Pass
		{
			...
			float4 frag(v2f IN) : SV_Target
			{
				...
				* (1.1 - 0.2 * tex2D(_Global_Noise_Lookup, blickUv*10 +_Effect_Time.y ));
				...
				_Color.a *= (sharp + softGlow * _SoftGlow * (1-sharp)) * smoothstep(0.95, 1, tex.a);

				tex.rgb += _Color.rgb * _Color.a;
