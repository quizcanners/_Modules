Shader "Quiz cAnners/UI/Procedural/Pixel Line" {
	Properties{
		[PerRendererData]_MainTex("Albedo (RGB)", 2D) = "black" {}
		[KeywordEnum(Inside, left, Right, Sides)] _GRADS("Start From ", Float) = 0
	...
	Category{
		...
		SubShader{
			Pass{
				...
				#pragma shader_feature_local _GRADS_SIDES _GRADS_RIGHT _GRADS_LEFT _GRADS_INSIDE 
				#pragma target 2.0
