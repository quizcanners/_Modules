Shader "Quiz cAnners/UI/Procedural/Pixel Perfect Screen Space" {
	Properties
	{
		[PerRendererData]
	...
	SubShader
	{
		...
		Pass
		{
			...
			#pragma shader_feature_local __  _SOFT_FADE
			#pragma shader_feature_local _MODE_PIXPERFECT _MODE_FILLSCREEN 
