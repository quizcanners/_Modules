Shader "Quiz cAnners/UI/Procedural/Unlinked/Gradient Unlinked"
{
	Properties{
	...
	Category{
		...
		SubShader{
			Pass{
				...
				#pragma shader_feature_local __ FADE

				#pragma shader_feature_local _GRAD_HOR _GRAD_VERT 
				#pragma shader_feature_local _GRADS_ONCE _GRADS_MIRROR
