Shader "Quiz cAnners/Effects/Directed Light Two Sided" 
{
	Properties
	{
	...
	Category
	{
		...
		SubShader
		{
			Pass
			{
				...
				#pragma shader_feature_local ___ _TWO_SIDED
				#pragma target 3.0
				...
				v2f vert(appdata_full v) 
				{
					...
					o.objectScale = length(float3( m[0][0], m[1][0], m[2][0]));
				...
				float4 frag(v2f i) : COLOR
				{
					...
					float fade = smoothstep(-0.5 * i.objectScale, -0.5 * i.objectScale, sceneZ - partZ);
