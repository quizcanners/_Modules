Shader "Quiz cAnners/Effects/InfiniteParticle" 
{
	...
	Category{
		...
		SubShader{
			...
			Pass{
				...
				#pragma shader_feature_local ____  _FADEOUT 
				#pragma shader_feature_local SCREENSPACE
				#pragma shader_feature_local DYNAMIC_SPEED
				#pragma target 3.0
	...
	CustomEditor "PlaytimePainter.Examples.InfiniteParticlesDrawerGUI"
}