...
namespace QuizCanners.SavageTurret.Triggers.Dialogue
{
    ...
    public class SO_Dialogue : CfgSelfSerializationBaseScriptableObject, IPEGI, ISerializationCallbackReceiver, ICfg
    {
        ...
        protected int LogicVersion => Singleton.GetValue<Singleton_TriggerValues, int>(s => s.Version, defaultValue: _questVersion);
