...
{
    [CreateAssetMenu(fileName = FILE_NAME, menuName = Utils.QcUnity.SO_CREATE_MENU + "/Tests/" + FILE_NAME)]
    ...
    [PEGI_Inspector_Override(typeof(SO_SimpleOfflineGeneratorTest))] internal class SimpleGeneratorTestDrawer : PEGI_Inspector_Override { }
